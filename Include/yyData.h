...
// Get current video data in player
// The parameter should YY_BUFFER **. 
#define	YYPLAY_PID_VideoData		YY_PLAY_DATA_BASE + 13

// Set ext render video data
// The parameter should YY_DATACB *. 
#define	YYPLAY_PID_VideoExtRnd		YY_PLAY_DATA_BASE + 14
...
#define	YY_64_INVALID			0X8000000000000000
#define	YY_64_MAXVAL			0XFFFFFFFFFFFFFFFF
#define	YY_32_INVALID			0X80000000
#define	YY_32_MAXVAL			0XFFFFFFFF
...
#define	YYBUFF_KEY_FRAME		0X00000010

// for dec
#define	YYBUFF_DEC_DISABLE		0X00000100
#define	YYBUFF_DEC_DISA_DEBLOCK	0X00000200
#define	YYBUFF_DEC_SKIP_BFRAME	0X00000400
#define	YYBUFF_DEC_RENDER		0X00000800
#define	YYBUFF_DEC_SOFT			0X00001000

// for render
#define	YYBUFF_RND_DISABLE		0X00010000
...
#define	YYBUFF_TYPE_TEXT		0X00100000	// the nValue is duration
#define	YYBUFF_TYPE_AVSubTT		0X00200000	// the nValue is duration
...
typedef struct
{
	...
	RECT *			pZoom;			/*!< Source buffer zoom rect*/
} YY_BUFFER_CONVERT;
...
typedef struct
{
	...
	TCHAR *					pSource;	/*!< the source file name */
